...
1) Go to the About page to see aggregation function/invoices example running
...
3) Use genericConstraints.ts to test the various genercis constraints features
