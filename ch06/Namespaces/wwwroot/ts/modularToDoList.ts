namespace App {
    import ListImplementation = DOMLists.Plain.ItemListImplementation;
    class MyULAppendGrid extends DOMLists.AppendGrid<string> {
        constructor(list: DOMLists.ItemList<string>,
    ...
    var mainList = new ListImplementation(
